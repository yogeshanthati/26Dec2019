...
public abstract class TestBase extends Constants {	
	...
	public static void intialization() throws MalformedURLException{
		...
		if(browserName.equals("chrome")){
			System.setProperty("webdriver.chrome.driver","./src/main/resources/BrowserSpecificDrivers/chromedriver.exe");	
		...
		//	driver = new FirefoxDriver(capabilities); for latest version selenium4 no need to set capabilities in firefox.
		}
		else {
